...
Status: ACCEPTED FOR PHASE 5B2A DESIGN. EXACT PHASE 5B2B IMPLEMENTATION COMMIT `e9c1981d37a6742011a8b8fdd854f9279c6d7fbd` IS ACCEPTED ONLY AS A FAKE-ONLY OFFLINE FOUNDATION; THE FOUR-RULE V2 GEOMETRY CORRECTION IS ACCEPTED, AND EXACT PROMPT PACKAGE V2 CONTENT IS SEPARATELY APPROVED. V2 ACTIVATION/PREPARATION, CREDENTIALS, INSTALLED-CLI CAPABILITY/PRIVACY PROOF, REAL CLI INVOCATION, PROVIDER CALLS, MODEL-RUN RECORDS, AND ALL LATER AUTHORITY REMAIN UNAUTHORIZED.
...
This ADR accepts only Phase 5B2A design. The later immutable `PHASE5B2B_IMPLEMENTATION_AUTHORIZATION_V1.json`, hash `sha256:b13c748a744d2c772006af596411e8ece145a99feed02a043e31cb5cb3f349ae`, separately authorized only the offline contracts, fake-executable adapter foundation, unapproved V2 proposal, exports, and governance synchronization. `PHASE5B2B_IMPLEMENTATION_ACCEPTANCE_V1.json`, record hash `sha256:609994e62021317f6a0c1de1886061a1b091d443b2f4422bcc2f942030a7ccf7`, accepts exact commit `e9c1981d37a6742011a8b8fdd854f9279c6d7fbd` only within that fake-only offline boundary. Post-acceptance review showed that its V2 validator did not yet bind the three proposed normalized prices to the referenced entry, protection, and objective anchors. Calvin therefore deferred exact Prompt Package V2 approval and authorized only the four minimal correction rules in `PHASE5B2B_GEOMETRY_VALIDATION_CORRECTION_AUTHORIZATION_V1.json`, record hash `sha256:3ae8d0ace9dc610a78db6fcabb300ffecbfd24b7f62f8c54ff743a3b3de28aef`. `PHASE5B2B_GEOMETRY_VALIDATION_CORRECTION_ACCEPTANCE_V1.json`, record hash `sha256:d5358718426069376660ee7d381ca7062f7141926105edd0237d4b5197054d76`, accepts exact correction commit `7e44a44b34fc4b5695af6f00d7366b989a42e716` only for those four offline relation checks. After that acceptance Calvin separately approved exact Prompt Package V2 content hash `sha256:d1af1c9ba80163642ae2dde29f34f06d3c3c7b43acc505d4c32db51c08f02598` in `BROOKS_PROMPT_PACKAGE_V2.approval.json`, record hash `sha256:429c5d53086a77c9bf826a20c23e11d08d53ef4d36bdda591ceefe18931affce`. The approval artifact is outside the package preimage and authorizes no activation or preparation. A first external call still requires another explicit bounded authorization after separate activation and preparation plus installed-CLI privacy, isolation, output-protocol, and hidden-retry proof.
...
The values are provider-proposed policy semantics, not real prices or execution fills. Local deterministic validation must verify finite values, directional ordering, structural references, visible-prefix anchoring, protection/objective side, and the existing Swing `>= 2.0R` requirement without repair. The accepted minimal numeric bindings are exact: a long stop entry is strictly above its visible anchor and a short stop entry strictly below; long protection is strictly below its visible anchor and short protection strictly above; a limit entry equals at least one visible anchor price in its referenced structure; and an objective equals at least one visible anchor price in the structure referenced by its magnet. No tick, minimum distance, buffer, or tolerance is inferred.
...
Under the separate authorization, the repository now contains pure candidate/request/terminal contracts, initial V2 stop/limit geometry validation, fixed resource limits, an isolated five-file workspace, one content-hashed fake executable, bounded process-group supervision including resistant-descendant termination, strict closed-envelope decoding, and non-executing candidate profile builders with bounded self-hashed Codex preflight evidence. Post-acceptance review demonstrated that the initial V2 validator accepted prices that were directionally ordered but detached from the referenced entry, protection, or objective anchors. The separately authorized and accepted correction now requires strict stop-entry and protection-side relations and exact visible-anchor equality for limit entries and objectives. The exact Prompt Package V2 manifest remains byte-for-byte in its `unapproved` proposal state, while the separate approval artifact now approves that exact package content identity without entering the package preimage or authorizing activation. Antigravity remains unavailable because exact non-interactive PNG transport is not implemented or proved. No real `agy`/Codex invocation, provider request, runtime record, migration, API/CLI route, deployment, credential, or production BrooksDecision was added.

The immutable implementation acceptance binds exact commit `e9c1981d37a6742011a8b8fdd854f9279c6d7fbd` and tree `d99df5d3a794d3056617383411f1caa78729666e` only as the reviewed fake-only offline foundation. The additive correction acceptance binds exact commit `7e44a44b34fc4b5695af6f00d7366b989a42e716` and tree `b1c9a15b822ef76344d3e7a66d73961621a40bed` only as the reviewed four-rule geometry correction. Neither acceptance treats the injected `--cd` capability mapping as proof of installed Codex user-config/rule exclusion or ordinary-home isolation, accepts a production signal/crash cleanup lifecycle, or decides future stdout-envelope versus terminal-file authority or cross-process concurrency. Those remain fail-closed prerequisites for a separately implemented and authorized production seam.

## Not authorized

This ADR, the offline implementation authorization, the exact-commit implementation acceptance, and the additive geometry-correction acceptance do not authorize:
...
- Prompt Package V2 activation or payload preparation;
