...
ADR-0003 makes the Brooks Policy Agent the sole first runtime policy and keeps Calvin auxiliary and offline. ADR-0008 fixes V1 scheduling, ADR-0009 fixes the five-minute V1 decision cadence, and ADR-0010 freezes the V1 BrooksDecision, whole-decision CalvinReview, and deterministic Conflict semantics. ADR-0024 preserves those bytes while requiring a versioned multi-timeframe core capability before formal provider evaluation and separate scaling, active-position management, and intrabar spike/event design tracks. `PHASE3D_MULTI_TIMEFRAME_CAPABILITY_CONTRACT_APPROVAL_V1.json`, record hash `sha256:0107f512023f2e0e33bd892ba262e3ba3db24e0224d0dadea50c65b67b6eaf3c`, accepts exact Phase 3D contract hash `sha256:989eb4a9717aff887fd5c970abf6bd14e53e97f4e37216779e4d287774a50b90` as the multi-timeframe design baseline only. `PHASE3D1_IMPLEMENTATION_AUTHORIZATION_V1.json`, record hash `sha256:85b4102a24874ff46fee7be7b07856c6ff0cb7f05f5448feb17f77b85c35f1fb`, now authorizes the exact offline synthetic foundation plan with zero new dependencies, an isolated worktree, Direct Pi as sole writer, and one fresh-context read-only review. `PHASE3D1_IMPLEMENTATION_ACCEPTANCE_V1.json`, record hash `sha256:10ebe854fb8daf0ef9e7a033601610f01a6e908bda44a4414e7f807691c9e108`, accepts exact commit `e1757c4916811260f9e853ccbfcbccb6c06839d3` and tree `21fa792ba769c5410010e097c026f150ff2948a4` only as the reviewed offline synthetic foundation. It grants no operational authority.

Still open:

- define and separately accept the remaining native real-source integration, correction-ingestion, semantic coverage, package, and evaluation prerequisites before claiming full Phase 3D capability completion;
